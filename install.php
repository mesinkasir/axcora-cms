	...
	file_put_contents(
		...
		$dataHead.json_encode(
			array(
				'position'=>1,
				'label'=>$L->get('About'),
				'text'=>$L->get('This project is a free and open source code flatfile resto cms present by axcora technology bludit for built fast website include SEO injection.
