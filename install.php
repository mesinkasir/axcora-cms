...
function install($adminPassword, $timezone)
{
	...
	$data = array(
		'title'=>'RESTO CMS',
		'slogan'=>$L->get('Welcome to resto cms'),
		'description'=>$L->get('Congratulations you have successfully installed your resto cms axcora bludit'),
	...
	$data = array(
		array(
			'date'=>$currentDate,
			'dictionaryKey'=>'Welcome to resto cms',
			'notes'=>'',
			'idExecution'=>uniqid(),
			'method'=>'POST',
			'username'=>'admin'
	...
	file_put_contents(
		...
		$dataHead.json_encode(
			array(
				'position'=>1,
				'label'=>$L->get('About'),
				'text'=>$L->get('Bluger is a free and open source code flatfile resto cms present by axcora technology bludit for built fast website include SEO injection.
...
Visit on /admin on your url , then login using default user with
username : admin
password : 12345678
then you can visit on your backend admin area for work with resto flatfile cms.
...
Bluger categories , Bluger Contact, Bluger Tags, Open Graph , Twitter Cards 

FAST SETTUP
For fresh installation - after installation success you need to configure on source code file , open source code project then delete bl-content .
Now you can rename bl-content-demo to be bl-content, and refresh your site.
Need to configuration - bl-content/database/site.php and search code 
    "url": "http:\/\/localhost:666\/bluger\/",
change localhost with your domain url and change bluger with your project name.
...
if (alreadyInstalled()) {
	$errorText = 'Resto CMS Axcora Bludit is already installed ;)';
	error_log('[ERROR] '.$errorText, 0);
	exit($errorText);
}
...
<html>
<head>
	<title><?php echo $L->get('Resto CMS Axcora Bludit Installer') ?></title>
...
<div class="container">
	<div class="row justify-content-md-center pt-5">
		<div class="col-md-4 pt-5">
			<h1 class="text-center mb-5 mt-5 font-weight-normal text-uppercase" style="color: #555;"><?php echo $L->get('Resto CMS Installer') ?></h1>
			<p class="lead">A flatfile cms for restaurant food shop and cafe present by axcora technology bludit</p>
