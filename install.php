...
function install($adminPassword, $timezone)
{
	...
	$data = array(
		'title'=>'AXCORA ART CMS',
		'slogan'=>$L->get('Welcome to axcora art cms'),
		'description'=>$L->get('Congratulations you have successfully installed your axcora art cms for artworker and photogrpaher'),
	...
	$data = array(
		array(
			'date'=>$currentDate,
			'dictionaryKey'=>'Welcome to axcora art cms',
			'notes'=>'',
			'idExecution'=>uniqid(),
			'method'=>'POST',
			'username'=>'admin'
	...
	// File categories.php
	$data = array(
		'street'=>array('name'=>'Promo', 'description'=>'', 'template'=>'', 'list'=>$slugs),
		'conceptual'=>array('name'=>'Food', 'description'=>'', 'template'=>'', 'list'=>array()),
		'fashion'=>array('name'=>'Drink', 'description'=>'', 'template'=>'', 'list'=>array())
	);
	...
	file_put_contents(
		...
		$dataHead.json_encode(
			array(
				'position'=>1,
				'label'=>$L->get('About'),
				'text'=>$L->get('This project is a free and open source code flatfile cms present by axcora technology bludit for built fast website include SEO injection.
...
Paimo Contact , Open Graph , Twitter Cards 
...
if (alreadyInstalled()) {
	$errorText = 'Axcora Art Axcora Bludit is already installed ;)';
	error_log('[ERROR] '.$errorText, 0);
	exit($errorText);
}
...
<html>
<head>
	<title><?php echo $L->get('Axcora Art Axcora Bludit Installer') ?></title>
...
<div class="container">
	<div class="row justify-content-md-center pt-5">
		<div class="col-md-4 pt-5">
			<h1 class="text-center mb-5 mt-5 font-weight-normal text-uppercase" style="color: #555;"><?php echo $L->get('Axcora Art Installer') ?></h1>
