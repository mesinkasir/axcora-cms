...
function install($adminPassword, $timezone)
{
	...
	$data = array(
		'title'=>'AXCORA CMS',
		'slogan'=>$L->get('👋 Welcome to axcora cms'),
		'description'=>$L->get('Congratulations you have successfully installed your axcora axcora cms🚀'),
	...
	$data = array(
		array(
			'date'=>$currentDate,
			'dictionaryKey'=>'👋 Welcome to axcora cms',
			'notes'=>'',
			'idExecution'=>uniqid(),
			'method'=>'POST',
			'username'=>'admin'
	...
	file_put_contents(
		...
		$dataHead.json_encode(
			array(
				'position'=>1,
				'label'=>$L->get('About'),
				'text'=>$L->get('This project is a free and open source code flatfile axcora cms present by axcora technology bludit for built fast website include SEO injection.
...
then you can visit on your backend admin area for work with axcora flatfile cms.
...
<html>
<head>
	<title><?php echo $L->get('Axcora CMS Axcora Bludit Installer') ?></title>
...
<link rel="icon" type="image/x-icon" href="https://axcora.axcora.com/img/AXCORACSS-ICON.jpg" />
...
<div class="container">
	<div class="row justify-content-md-center pt-5">
		<div class="col-md-4 pt-5">
			<h1 class="text-center mb-5 mt-5 font-weight-normal text-uppercase" style="color: #555;"><?php echo $L->get('👩‍🚀 Axcora CMS Installer') ?></h1>
