...
function install($adminPassword, $timezone)
{
	...
	$data = array(
		'title'=>'ASTRONOT CMS',
		'slogan'=>$L->get('👋 Welcome to astronot cms'),
		'description'=>$L->get('Congratulations you have successfully installed your axcora astronot cms🚀'),
	...
	$data = array(
		array(
			'date'=>$currentDate,
			'dictionaryKey'=>'👋 Welcome to astronot cms',
			'notes'=>'',
			'idExecution'=>uniqid(),
			'method'=>'POST',
			'username'=>'admin'
	...
	file_put_contents(
		...
		$dataHead.json_encode(
			array(
				'position'=>1,
				'label'=>$L->get('About'),
				'text'=>$L->get('This project is a free and open source code flatfile astronot cms present by axcora technology bludit for built fast website include SEO injection.
...
if (alreadyInstalled()) {
	$errorText = 'Astronot CMS Axcora Bludit is already installed ;)';
	error_log('[ERROR] '.$errorText, 0);
	exit($errorText);
}
...
<html>
<head>
	<title><?php echo $L->get('Astronot CMS Axcora Bludit Installer') ?></title>
...
<link rel="icon" type="image/x-icon" href="https://astronot.axcora.com/img/ASTRONOTCSS-ICON.jpg" />
...
<div class="container">
	<div class="row justify-content-md-center pt-5">
		<div class="col-md-4 pt-5">
			<h1 class="text-center mb-5 mt-5 font-weight-normal text-uppercase" style="color: #555;"><?php echo $L->get('👩‍🚀 Astronot CMS Installer') ?></h1>
