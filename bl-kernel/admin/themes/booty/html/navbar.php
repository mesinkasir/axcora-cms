		...
		<div class="collapse navbar-collapse" id="navbarNav">
			<ul class="navbar-nav">
				...
				<?php if (checkRole(array('admin'),false)): ?>
						...
						<li class="nav-item">
							<a class="nav-link" href="https://bludit.axcora.com/tailwind/">
