...
class pluginBanditContact extends Plugin {
	...
	public function form()
	{
		...
		$html .= '<div>';
		$html .= '<label>'.$L->get('Bandit Contact').'</label>';
	...
	{
		$html  = '<div class=" col-md-12 p-3 p-md-5 bg-dark mt-3 plugin plugin-bandit-contact text-white text-center rounded shadow">';
